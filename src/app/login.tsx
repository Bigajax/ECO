  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center px-6 py-12 bg-gradient-to-br from-[#c5e8ff] via-[#e9f1ff] to-[#ffd9e6] animate-gradient-x">
      <div className="w-full max-w-md">
        <div className="flex justify-center mb-12 scale-in-center">
        ...
        <div className="bg-white bg-opacity-70 backdrop-blur-sm rounded-3xl p-8 shadow-lg fade-in-bottom">
          ...
          <div className="my-6 border-t border-gray-300 text-center relative">
            <span className="absolute -top-3 bg-white text-gray-500 px-3">ou</span>
          </div>

          <div className="space-y-4">
            <button 
              className="w-full flex items-center justify-center gap-2 py-3 bg-white rounded-xl shadow-md hover:shadow-lg transition"
