    ...
    <div className="min-h-screen bg-gradient-to-b from-[#E9DEFA] via-[#FBFCDB] to-[#E9DEFA] flex flex-col items-center p-8">
      ...
      <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-8 shadow-[0_0_50px_rgba(0,0,0,0.05)] max-w-md w-full">
        <div className="flex items-center gap-4 mb-6">
          {/* Bolha ECO (igual à da tela de mensagem - TENTATIVA SIMPLIFICADA) */}
          <div className="relative w-12 h-12 rounded-full bg-white/70 shadow-md flex items-center justify-center overflow-hidden">
            {/* Gradiente suave */}
            <div className="absolute inset-0 bg-gradient-to-br from-white/80 via-white/50 to-white/30 rounded-full"></div>
            {/* Brilho */}
            <div className="absolute top-0 left-0 w-6 h-6 rounded-full bg-white/90 blur-sm opacity-70"></div>
          </div>
          <div>
