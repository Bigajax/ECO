...
import Landing from './Landing'; // Caminho correto: Landing está na mesma pasta
import Interaction from './Interaction'; // Caminho correto: Interaction está na mesma pasta
